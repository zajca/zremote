...
impl AgenticProcessor {
    ...
    async fn handle_loop_tool_call(
        ...
        status: zremote_protocol::ToolCallStatus,
    ) -> Result<(), AppError> {
    ...
    async fn handle_loop_transcript(
        &self,
        loop_id: AgenticLoopId,
        role: zremote_protocol::agentic::TranscriptRole,
        content: String,
...
mod tests {
    ...
    use dashmap::DashMap;
    use tokio::sync::broadcast;
    use zremote_protocol::agentic::{AgenticStatus, ToolCallStatus, TranscriptRole};
